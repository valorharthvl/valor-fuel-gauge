...
- Extension name changed to "AI & API Usage Limit & Credit Tracker" for Chrome Web Store SEO optimization. Name was chosen based on SEO search intent — leads with what users search at moment of pain.
